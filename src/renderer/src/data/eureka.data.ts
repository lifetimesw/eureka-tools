...
export const eurekaLogos: Logos[] = [
  {
    ...
    description: ['令自身发动魔法攻击造成的伤害提高60%', '无法与其他“记忆”系技能同时使用', '切换任务指令时消失', ['再次发动时则取消该状态', '持续时间：永久']],
  },
  {
    order: 2,
    icon: '064602',
    ...
    description: ['令自身发动物理攻击造成的伤害提高40%', '无法与其他“记忆”系技能同时使用', '切换任务指令时消失', ['再次发动时则取消该状态', '持续时间：永久']],
  },
  {
    order: 3,
    icon: '064603',
    ...
    description: ['令自身所受到的伤害减轻80%，并且最大体力提高50%', '无法与其他“记忆”系技能同时使用', '切换任务指令时消失', ['再次发动时则取消该状态', '持续时间：永久']],
  },
  {
    order: 4,
    icon: '064604',
    ...
    jobs: [{ name: '防护职业', icon: '062581' }],
    description: ['令自身所受到的伤害减轻45%，并且最大体力提高10%', '无法与其他“记忆”系技能同时使用', '切换任务指令时消失', ['再次发动时则取消该状态', '持续时间：永久']],
  },
  {
    order: 5,
    icon: '064605',
    ...
    jobs: [{ name: '治疗职业', icon: '062582' }],
    description: ['令自身最大魔力提高50%，并且发动治疗魔法的治疗量提高25%', '无法与其他“记忆”系技能同时使用', '切换任务指令时消失', ['再次发动时则取消该状态', '持续时间：永久']],
  },
  {
    order: 6,
    icon: '064606',
    ...
    description: ['令自身发动攻击造成的伤害提高20%', '无法与其他“记忆”系技能同时使用', '切换任务指令时消失', ['再次发动时则取消该状态', '持续时间：永久']],
  },
  {
    order: 7,
    icon: '064607',
    ...
    jobs: [{ name: '防护职业', icon: '062581' }],
    description: ['以自身发动攻击造成的伤害降低5%为代价，令自身的回避率提高25%', '无法与其他“记忆”系技能同时使用', '切换任务指令时消失', ['再次发动时则取消该状态', '持续时间：永久']],
  },
  {
    order: 8,
    icon: '064608',
    ...
    jobs: [{ name: '治疗职业', icon: '062582' }],
    description: ['以自身发动攻击造成的伤害降低5%为代价，令自身的最大体力提高30%，并且发动治疗魔法的治疗量提高50%', '无法与其他“记忆”系技能同时使用', '切换任务指令时消失', ['再次发动时则取消该状态', '持续时间：永久']],
  },
  {
    order: 9,
    icon: '064609',
    ...
    description: ['以令自身魔法防御力降低60%为代价提高30%发动攻击造成的伤害', '无法与其他“记忆”系技能同时使用', '切换任务指令时消失', ['再次发动时则取消该状态', '持续时间：永久']],
  },
  {
    order: 10,
    icon: '064610',
    ...
    description: ['令自身回避率提高10%，并且移动速度提高、中毒耐性提高，该移动速度提高效果在骑乘坐骑时有效', '无法与其他“记忆”系技能同时使用', '切换任务指令时消失', ['再次发动时则取消该状态', '持续时间：永久']],
  },
  {
    order: 11,
    icon: '064611',
    ...
    description: ['令自身最大体力提高10%，并且命中率提高30%', '持续时间内若陷入无法战斗状态，有70%几率自动复活', '持续时间：180分'],
  },
  {
    order: 12,
    icon: '064612',
  ...
  },
  {
    ...
    description: ['对自身附加蓄力状态，最多可以积累16档', '“蓄力”效果：效果时间内自身发动的1次战技威力提高，效果量为每档提高30%', '持续时间：30秒', '与战技和魔法共享复唱时间'],
  },
  {
    order: 16,
    icon: '064614',
  ...
  },
  {
    ...
    jobs: [{ name: '治疗职业', icon: '062582' }],
    description: [['对目标发动无属性魔法攻击。', '威力：200'], '目标为不死系怪物时发动追加效果', '追加效果：目标所受伤害提高25%', '持续时间：60秒'],
  },
  {
    order: 47,
    icon: '064640',
    ...
    jobs: [{ name: '治疗职业', icon: '062582' }],
    description: [['对目标及其周围的敌人发动无属性范围魔法攻击。', '威力：150'], '目标为不死系怪物时发动追加效果', '追加效果：目标所受伤害提高25%', '持续时间：60秒'],
  },
  {
    order: 48,
    icon: '064648',
  ...
  },
  {
    ...
    description: ['一定时间内，以自身体力逐渐流失为代价，令发动物理攻击造成的伤害提高', '该状态每3秒增加1档，最多可以积累16档', '每档可以令物理伤害提高15%、令体力流失增加360点', '持续时间：48秒'],
  },
  {
    order: 50,
    icon: '064650',
    ...
    description: [['对目标发动远距离物理攻击。', '威力：80'], '目标剩余体力越少威力越大，最大提升到10倍', '该技能拥有高仇恨提升率'],
  },
  {
    order: 51,
    icon: '064651',
  ...
  },
  {
    ...
    description: ['令自身发动魔法攻击造成的伤害提高35%，所受到的魔法伤害减轻22%，并且发动魔法消耗的魔力降低', '无法与其他“记忆”系技能同时使用', '切换任务指令时消失', ['再次发动时则取消该状态', '持续时间：永久']],
  },
  {
    order: 53,
    icon: '064653',
    ...
    description: ['令自身发动物理攻击造成的伤害提高40%，最大体力增加15%', '无法与其他“记忆”系技能同时使用', '切换任务指令时消失', ['再次发动时则取消该状态', '持续时间：永久']],
  },
  {
    order: 54,
    icon: '064654',
    ...
    jobs: [{ name: '远程物理职业', icon: '062586' }],
    description: ['令自身发动物理攻击造成的伤害提高25%，并且回避率提高25%', '无法与其他“记忆”系技能同时使用', '切换任务指令时消失', ['再次发动时则取消该状态', '持续时间：永久']],
  },
  {
    order: 55,
    icon: '064655',
    ...
    jobs: [{ name: '防护职业', icon: '062581' }],
    description: ['令自身受到的伤害减轻64%', '效果时间内每次受到大于等于自身最大体力50%的单体攻击伤害时，获得1档体力增加', '无法与其他“记忆”系技能同时使用', '切换任务指令时消失', ['再次发动时则取消该状态', '持续时间：永久']],
  },
  {
    order: 56,
    icon: '064656',
    ...
    jobs: [{ name: '治疗职业', icon: '062582' }],
    description: ['复活目标并恢复其全部体力', ['追加效果：对自己附加献祭状态', '持续时间：10秒'], '献祭效果：持续时间结束后自身将陷入无法战斗的状态', '发动条件：非献祭状态中'],
  },
]
